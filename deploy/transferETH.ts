...
const ACCOUNT_ADDRESS = "0x5194f938E14ddC0ef8A81c62d0DC9A06eB538964";

export default async function (hre: HardhatRuntimeEnvironment) {
  // @ts-ignore target zkSyncTestnet in config file which can be testnet or local
  const provider = new Provider(hre.config.networks.zkSyncTestnet.url);

  const owner = new Wallet("0xe3e8c1768f7cd3dee89c6b26c9a7bf5b8744ecfeb5403d5daa8a8837a6e73c9e", provider);

  // account that will receive the ETH transfer
  const receiver = "0x09e626AC7422597415F75946eE39a97d0c281b07";
