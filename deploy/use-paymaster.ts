...
const PAYMASTER_ADDRESS = "0x1960A90406C368D17b01D63B6554b749Cbd00a1C";
...
function getToken(hre: HardhatRuntimeEnvironment, wallet: Wallet) {
  const artifact = hre.artifacts.readArtifactSync("@matterlabs/zksync-contracts/l2/system-contracts/openzeppelin/token/ERC20/IERC20.sol:IERC20");
  return new ethers.Contract(TOKEN_ADDRESS, artifact.abi, wallet);
}

// Withdraw contract
function getWithdraw(hre: HardhatRuntimeEnvironment, wallet: Wallet) {
  const artifact = hre.artifacts.readArtifactSync("IWithdraw");
  return new ethers.Contract(WALLET_ADDRESS, artifact.abi, wallet);
}
